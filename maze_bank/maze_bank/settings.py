...
SECRET_KEY = 'django-insecure-0qxmoi6hlg&+%gx#0pi7pw=6x-ei#jqx*$@@0#ao86=mj56_w1'
...
WSGI_APPLICATION = 'maze_bank.wsgi.application'
...
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'static') # в режиме эксплуатации
STATICFILES_DIRS = [] # в случае нестандартных путей
